...
pathoschild.i18n = {
    ...
    regexeditor: {
        ...
        instructions: 'কার্যকর করার জন্য রেগুলার এক্সপ্রেশনের যে কোন একটি নম্বর লিখুন। অনুসন্ধান প্যাটার্ন দেখতে "{code|text=অনুসন্ধান প্যাটার্ন}" বা "{code|text=/pattern/modifiers}"-এর মত হতে পারে, এবং প্রতিস্থাপন প্যাটার্নে তথ্যসূত্রের গ্রুপ থাকতে পারে যেমন "{code|text=$1}" ({helplink|text=নির্দেশিকা|title=জাভাস্ক্রিপ্ট regex টিউটোরিয়াল|url=https://www.regular-expressions.info/javascript.html} দেখুন)।'
    }
};
